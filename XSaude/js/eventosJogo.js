...
function Score(contador, score, contadordois, scoredois){
	...
	if(contadordois == 1)
	{
		...
		if(scoredois < 30)
		{
			...
			if (confirm('Gostaria de tentar novamente???'))
				window.location.href ="jogo2.html"; else alert('Voltando para a página inicial..'); window.location.href ="index.html";
		}
		...
		else
		{
		    ...
		    if (confirm('Deseja voltar para o menu?'))
	      	...
	      	window.location.href ="menu.html"; else alert('Voltando para a página inicial..'); window.location.href ="index.html";
		}
